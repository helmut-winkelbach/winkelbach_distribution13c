...
namespace WinkelbachWebdesign\WinkelbachDistribution13c\Service;

use WinkelbachWebdesign\WinkelbachDistribution13c\Icons\IconProviderInterface;
...
class IconService
{
    ...
    {
        $iconSets = [];
        $iconSets[] = ['LLL:EXT:winkelbach_distribution13c/Resources/Private/Language/Backend.xlf:option.none', ''];
    ...
    public function getIconItems(array &$configuration): void
    {
        $iconItems = [];
        $iconItems[] = [
            'LLL:EXT:winkelbach_distribution13c/Resources/Private/Language/Backend.xlf:option.none',
            0,
            'EXT:winkelbach_distribution13c/Resources/Public/Images/Icons/none.svg',
        ];
